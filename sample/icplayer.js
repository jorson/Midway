...
module.exports = {
    'define': function (key, fn, type) {
        if (key in definitions) {
            throw new Error("player 9.0.4: " + 'duplicate definition:' + key);
        }
        definitions[key] = fn;
        if (type === "automatic") {
            automatics.push(key);
...
var normalMode = function(tool, e) {
    ...
    var _w = tool.element.width(),
        ...
        _pageX = event.pageX ||event.originalEvent.touches[0].pageX,
        _pageY = event.pageY || event.originalEvent.touches[0].pageY;
    ...
    'getRuntime': function () {
        ...
        if (bridge && $.isFunction(bridge.getRuntime)) {
            ...
            if (typeof result === "object") {
                result = result[terminal.toLowerCase()] || runtime.__default__;
            }
        }
...
'use strict';
var timeObject = '.tooldiolag_com_header_time';
var miuteObject = '.tooldiolag_com_header_time .tooldiolag_time_m em';
var secondObject = '.tooldiolag_com_header_time .tooldiolag_time_s em';
var miute = 0,
	second = 0,
	interval;
...
__applicationContext.define('core.common.tool', function (exports,module,require,$) {
'use strict';
    ...
    getToolNameI18n: function (data, key) {
        ...
        for (var i = data.length - 1; i >= 0; i--) {
            if (data[i].toolKey === key) {
                toolName = data[i].i18n[lang]||data[i].i18n['zh_CN'];
                break;
            }
        }
        return toolName;
    ...
    "paint": {
        ...
        "getPaintSetting": function() {
            ...
            if (typeof(CoursePlayer) !== 'undefined' && CoursePlayer.drawMethod)
                result = JSON.parse(CoursePlayer.drawMethod("drawsetting", JSON.stringify({})));
            //do api
...
module.exports = {
    create: function (message, throwable, type) {
        var e = new Error("player 9.0.4: " + message);
        e.cause = throwable;
...
var When = require('core.utils.when');
var Paint = require('core.common.Paint');
var pptshellpaint = require('core.common.pptshellpaint');
var logger = require('core.utils.log');
...
var adjust = require('core.common.ispointinpath');
...
var toolTargetHtml = '<div class="ic_paint"><div class="ic_tool_container tooldiolag_skin_wood"><div class="com_tooldiolag"><div class="sideicon_wrap leftwrap scrollbar_style_gray" ><ul class="sideicon_list"></ul></div><div class="sideicon_wrap rightwrap scrollbar_style_gray" ><ul class="sideicon_list"></ul></div></div><div class="com_tooldiolag_pop" style="display:none;z-index:9999" onclick="$(this).hide()"><div class="com_tooldiolag_pop_box"><div class="com_tooldiolag_pop_main" ><p class="com_tooldiolag_pop_txt">${Tool_PopLimit}</p></div><div class="com_tooldiolag_pop_foot"><a class="com_tooldiolag_pop_btn" href="javascript:;">${Tool_See}</a></div></div></div></div></div>';
    ...
    return function () {
        ...
        upEvents.forEach(function (item) {
            var fn = function (e) {
                ...
                if (event.pageX || event.originalEvent.changedTouches[0]) {
        ...
        pageLeaveEvents.forEach(function (item) {
            var fn = function (event) {
                ...
                // var t = new Date() - downTime;
                // var x = Math.abs((event.pageX || event.changedTouches[0].pageX) - downX);
                // var y = Math.abs((event.pageY || event.changedTouches[0].pageY) - downY);
                // if (me.component.toolList.active !== '') {
                //     if (t < 180 && x < 3 && y < 3 && me.component.toolList.list[me.component.toolList.active].length > currentToolIndex) {
                //         me.component.toolList.list[me.component.toolList.active][currentToolIndex].fireEvent('click', event);
                //     }
...
module.exports = {
    ...
    'renderPage': function () {
        ...
        return this.component.activePage.render(this.pageTarget)
            .then(function () {
                logger.log('activePage render finished');
    ...
    'renderTool': function () {
        ...
        this.$toolTarget.find('.ic_tool_container,.exam_skin_wood').css('font-size', icCreatePlayer.fontSize + 'px');
        this.$toolContainer = this.$toolTarget.find('.com_tooldiolag');
        ...
        //var self = this;
        //var _index = 1;
        //$.each(toolContainerMapping, function (key) {
        //    var $target = $(toolContainerHtml);
        //    $target.css({'z-index': _index++});
        //    self.$toolTarget.append($target);
        //    toolContainerMapping[key] = toolContainerMapping[key]($target);
        //});
        return paint;
    },
    'activeTool': function () {
        ...
        proxy.getData(url, isCache)
            .fail(function () {
                if (config.ignoreError) {
                    var model = JSON.parse('{"presenters":{},"commons":{},"script":[],"icplayerVersion": "9.0.4"}');
                    defer.resolve({'model': model, 'baseUrl': baseUrl});
                } else {
                    defer.reject(new Error("player 9.0.4: " + 'ajax request error'));
                }
            })
...
var moduleTemplate = '<div class="addon_${presenterId} ic_module" id="${id}" style="${style}"></div>';


var ModuleInterface = {
    'Wrap': /^wrap$/,
    'Processer': /^(processBeforeRun|processAfterRun|setCallbackList)$/
};
...
module.exports = {
    ...
    _setModuleState: function (module) {
        ...
        if (stateValue) {
            module.setState([stateValue, this.gotoConfig.options || {}]);
        }
    },
...
var tHelper = require('core.common.tool');
var stringUtils = require("core.utils.string");
var createModel = require('core.common.createModel');
...
module.exports = {
    ...
    initComponent: function () {
        ...
        // i18nLoader.loadPlayer().done(function(langObject) {
        //     me.i18nModel.tool = langObject;
        // });
        this.playerFlows = {};
        require('core.common.printscreen').printScreen(this._eventbus);
        console.log('player version : 9.0.4')
    },
    ...
    "addExtendPage": function (config) {
        ...
        this.activePage = createPage.call(this, {
            "url": config.url,
            "pageType": "extendPage",
            "hidePage": config.hidePage
        });
        this.layout.renderPage();
    },
    /**
    ...
    renderModel: function (model, baseUrl) {
        ...
        if (this.pageUrl) {
            ...
            //var commonPageConfigs;
            //var me = this;
            //if (model && (commonPageConfigs = model.getAttribute('commons'))) {
            //    commonPageConfigs.forEach(function (pages, name) {
            //        pages.forEach(function (pageConfig) {
            //            me.commonPages.addItem(name, new Page(pageConfig, me));
            //        });
            //    });
            //}age
            if (this.hidePage) {
        ...
        if (me.toolList && me.toolList.all && me.i18nModel && me.i18nModel.tool && stoolkey && dtoolkey) {
            ...
            tool.load().done(function (data) {
                createModel(data.model.getValue().properties, data.baseUrl, tool.getRefPathParser()).then(function (model) {
                    if (stoolview) {
                        stoolview.find('.tooldiolag_head span img').attr('src', model.smallIcon);
                        stoolview.find('.tooldiolag_head em.title').text(tHelper.getToolNameI18n(me.i18nModel.tool, dtoolkey));
                        if (model.push) {
        ...
        me.waitI18nLoadDF.then(function () {
            ...
            me.addTool = function (url, options, state, extendOptions) {
                ...
                return me.waitI18nLoadDF.promise().then(function () {
                    var toolkey = Tool.getToolKey(url);
                    if (me.i18nModel && me.i18nModel.tool) {
                        $.each(me.i18nModel.tool, function (index, item) {
...
var parser = require('core.model.parser.toolParser'),
    ...
    tHelper = require('core.common.tool'),
    singleTools = {},
    toolLoadState = {}, //有三种状态 none,pending,done
    htmlMapping = {
        'up': '<div class="ic_tool"></div>',
        'down': '<div class="tooldiolag_control" style="visibility: hidden"><div class="tooldiolag_wrap" ><div class="tooldiolag_head" ><p class="tooldiolag_title"><span class="tooldiolag_title_icon"><img src="${smallIcon}"/></span><em class="title">${toolName}</em></p><div class="tooldiolag_com_header_time" style="display:none"><div class="tooldiolag_com_time"><div class="tooldiolag_time_default "><span class="tooldiolag_time_m"><em>00</em></span><i>:</i><span class="tooldiolag_time_s"><em>00</em></span></div></div> </div><div class="tooldiolag_headleft"></div> </div><div class="tooldiolag_content"></div><div class="sidetool lefttool"><div class="tool_wrap"><a class="_icplayer_push_button btn_tool tool_push ${ispushing}" style="display: ${display}"><div class="tool_push_icon"><div class="tool_push_icon_main"><span class="tool_push_icon_nor"></span><span class="tool_push_icon_end"></span></div></div></a><a class="btn_tool tool_small"></a><div class="tool_ctrol"><a class="btn_tool tool_close"></a><div class="tool_tip tool_tip_small" style="display: none;"><div class="tool_tip_wrap"><p class="tip_text" style="display: none;" id="tip_next_push"><em class="text">${pushed_tip}</em></p> <p class="tip_text" ><em class="text">${tip}</em></p> <a class="btn_tool_tip"><em class="btn_text">${sure}</em></a><a class="btn_tool_tip"><em class="btn_text">${cancel}</em></a></div></div></div><a class="btn_tool tool_full"></a></div><div class="tool_wrap_mask hide_dom"></div></div><div class="sidetool righttool"><div class="tool_wrap"><a class="_icplayer_push_button btn_tool tool_push ${ispushing}" style="display: ${display}"><div class="tool_push_icon"><div class="tool_push_icon_main"><span class="tool_push_icon_nor"></span><span class="tool_push_icon_end"></span></div></div></a><a class="btn_tool tool_small"></a><div class="tool_ctrol"><a class="btn_tool tool_close"></a><div class="tool_tip tool_tip_small" style="display: none;"><div class="tool_tip_wrap"><p class="tip_text" id="tip_next_push" style="display: none;"><em class="text">${pushed_tip}</em></p><p class="tip_text"><em class="text">${tip}</em></p><a class="btn_tool_tip"><em class="btn_text">${sure}</em></a><a class="btn_tool_tip"><em class="btn_text">${cancel}</em></a></div></div></div><a class="btn_tool tool_full"></a></div><div class="tool_wrap_mask hide_dom"></div></div></div></div>'
    },
    defaultToolPosition = {
        top: 0,
        left: 0,
    ...
    _maxCount = 3,
    itemLayout = {
        'right': 'tooldiolag_com_header_time',
        'left': 'tooldiolag_headleft'
    },
    pushing = false,
    currentPushTool;
        ...
        return $.when(promise).then(function () {
            ...
            if (me.toolConfig.independent !== true) {
                ...
                if (me.dialogModel.__type !== 'pc') {
                    ...
                    _stepLeft = icCreatePlayer.fontSize * 4 * 0.75;
                    _stepTop = icCreatePlayer.fontSize * 2.66667 * 0.75;
...
module.exports = {
    ...
    'static': {
        'getItemRender': function (name) {
            return '.tooldiolag_head > .' + itemLayout[name];
        },
    ...
    renderModel: function (model, baseurl) {
        ...
        return createModel(model.properties, baseurl, this.getRefPathParser())
            .then(function (_model) {
                if(window.icCreatePlayer.request('hidepush')==='true') _model.push=false;
                if (me.top.toolList.list.bottom.length >= 3 && toolLoadState[me.toolKey] == 'pending' && _model.independent !== true) {
                    var deferred = $.Deferred();
                    toolLoadState[me.toolKey] = undefined;
                    me.top.layout.$toolTarget.find('.com_tooldiolag_pop').show();
                    return deferred.reject(playerException.create('exceed max', new Error("player 9.0.4: " + "exceed max")));
                }
                if (_model.independent !== true) {
                    ...
                    el = $(stringUtil.applyTemplate(htmlMapping.down, {
                        ...
                        'ispushing': pushing ? 'click_disabled' : 'on',
                    ...
                    me.displayMode(modelType);
                    me.element = el;
                    var left, top;
                    var range = {};
                    var isMove = false;
                    me.layoutTarget = me.element.find('.tooldiolag_content');
                    me.addEventListener('mousedown', {
                        fn: function () {
                            ...
                            left = p.left - m.x;
                            top = p.top - m.y;
                            range.minLeft = 0 - me.element.width() + _stepLeft;
                            range.maxLeft = me.top.getElement(true).width() - _stepLeft;
                            range.minTop = 0;
                            range.maxTop = me.top.getElement(true).height() - _stepTop;
                        },
                        selector: ['.tooldiolag_head', '.btn_tool.tool_full']
                    });
                    me.addEventListener('mousedown', {
                        fn: function () {
                            if (!modelType.disabledMin) {
                                ...
                                if (currentPushTool === me.unqiueId) {
                                    side.addClass('on');
                                } else {
                                    side.removeClass('on');
                                }
                    ...
                    me.addEventListener('mousedown', {
                        fn: function () {
                            if (!modelType.disabledClose) {
                                if (pushing && currentPushTool === me.unqiueId) {
                    ...
                    me.addEventListener('mousedown', {
                        ...
                        fn: function () {
                            ...
                            if (event.type == 'mousedown') {
                                var target = $(event.srcElement || event.target);
                                if ((target.hasClass('_icplayer_push_button') || target.parent().parent().parent().hasClass('_icplayer_push_button')) && !pushing) {
                                    me.push();
                        ...
                        fn: function (eventName, eventData) {
                            if (eventData) {
                                ...
                                if (eventData.action == 'push') {
                                    if (!pushing && eventData.toolKey == me.toolKey && eventData.uniqueId == uniqueId) {
                                        me.push();
                                    }
                ...
                me.layoutConfig = $.extend({}, defaultToolPosition, Layout.createLayoutConfig(model.layout), Layout.createLayoutConfig(me.options, ['visibility', 'display']));
                if (_model.independent === true) {
                    me.element.css(me.layoutConfig);
                }
    ...
    displayMode: function (modelType, adjust) {
        var me = this;
        var _parent = me.element.parent();
        var sidetool = me.element.find('.sidetool');
        var head = me.element.find('.tooldiolag_head');

        me.element.removeClass('com_tooldiolag_student');
        me.element.removeClass('com_tooldiolag_board');
        ...
        switch (modelType.__type) {
            case "stu" :
            {
                me.element.addClass('com_tooldiolag_student');
            ...
            case "pre":
            {
                me.element.addClass('com_tooldiolag_board');
            ...
            case "pc":
            {
                _parent.css('font-size', ((window.screen.width < 1280) ? 16 : icCreatePlayer.fontSize) + 'px');
    ...
    release: function (NONEventFlag) {
        ...
        if ($(me.top.layout.$toolTarget.find('.com_tooldiolag_pop')).css("visibility") != "hidden")
            me.top.layout.$toolTarget.find('.com_tooldiolag_pop').hide();
        if (!NONEventFlag)
    ...
    push: function () {
        ...
        me.top.startFlow('exerciseStart', {
            ...
            me.element.find(pushClassName).addClass('on').removeClass('click_disabled');
            timer.start(me);
            ...
            if (me.toolConfig && me.toolConfig.autoFull) {
                me.displayMode({__type: "stu"}, true);
            ...
            $(pushClassName).removeClass('on').removeClass('tool_push_ing').removeClass('click_disabled');
            me.element.find(hideom).addClass('hide_dom');
            me.fireEvent(eventname.tool.push_data, {
                "toolKey": me.toolKey,
                "uniqueId": uniqueId,
...
module.exports = {
    constructor:function(options){
        ...
        var defaultOptions = {
            provider: function () {
                throw new Error("player 9.0.4: " + "No provider!");
            },
            maxLength: 30,
            onUpdate: function () { }
        };
...
var logger = {
    'log': function(message) {
        log("player 9.0.4: " + message, 'log');
    },
    'error': function(message, e) {
        log("player 9.0.4: " + message, 'error');
        if (e) {
            errorLog(e);
        }
    }
...
module.exports = {
	...
	"Tool_Sure": "Confirm",
	"Tool_Push": "Push",
	"Tool_Pushing": "Pushing",
	"Tool_Finish": "Completed",
	"Tool_Pushed_Tip": "The tool has already been pushed towards the students，it will also end the use of students if turning off it at this point",
	"Tool_Tip": "Are you sure you want to turn the tool off?",
	"Tool_Cancel": "Cancel",
	"Tool_PopLimit": "Teacher, has already opened 3 tools,<br/>please turn off the existing tools, and turn on a new tool.",
	"Tool_See": "I know..."
};
}, '');
...
module.exports = {
	...
	"Tool_Tip": "ツールを閉じますか？",
	"Tool_Cancel": "キャンセル",
	"Tool_PopLimit": "既に3つの教科ツールが開かれました，<br/>新たなツールを開く前に、開かれたツールを閉じてください。",
	"Tool_See": "了解です..."
};
}, '');
...
module.exports = {
	...
	"Tool_Tip": "确认关闭当前工具吗？",
	"Tool_Cancel": "取消",
	"Tool_PopLimit": "老师，已经打开3个学科工具，<br/>请先关闭已有的工具，再新开工具。",
	"Tool_See": "知道了..."
};
}, '');
...
window.icCreatePlayer = {
    ...
    'request': request,
    'detector': detector,
    'utils':{throttle:require('core.utils.throttle')},
